      ...
      if (session?.user?.email) {
        try {
          const response = await fetch(
            `/api/activities?email=${session.user.email}`
          );
          if (!response.ok) {
      ...
      <div className="flex flex-col space-y-4 text-white">
        <Link href="/home" passHref>
          <span className="flex items-center cursor-pointer">
            ...
            <span className="w-0 opacity-0 group-hover:w-fit group-hover:opacity-100 transition-opacity">
              Home
            </span>
          </span>
        </Link>
            ...
            >
              <g>
                <g>
                  ...
                  />
                  <path d="M242.5,30C125.327,30,30,125.327,30,242.5S125.327,455,242.5,455S455,359.673,455,242.5S359.673,30,242.5,30z" />
                </g>
                <g>
                  <polygon
                    fill="#20a48e"
